...
public class AuthorHelper {
    ...
    public void deleteCriteria(String columnName, String str)  {
        Session session = sessionFactory.openSession();
        ...
        cd.where(cb.like(root.<String>get(columnName), "%" + str + "%"));
    ...
    public void deleteCriteriaLogic(String columnName1, String columnName2)  {
        Session session = sessionFactory.openSession();
        ...
        cd.where(cb.or(
                cb.and(
                        cb.like(root.<String>get(columnName1), "%rr%"),
                        cb.like(root.<String>get(columnName2), "%hh%")
                ),
                cb.equal(root.get(columnName2), "Lermontov")
        ));
